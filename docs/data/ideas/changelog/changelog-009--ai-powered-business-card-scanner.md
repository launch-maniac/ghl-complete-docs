...
guid: "68ed4635c66ef78d40cd80a5"
author: "Nikhil Satish"
pubDate: "2025-10-13T18:57:22.000Z"
link: "https://ideas.gohighlevel.com/changelog/ai-powered-business-card-scanner"
categories: new
url: "https://ideas.gohighlevel.com/changelog/ai-powered-business-card-scanner"
index: 9
---
...
-   **Smart Refinement with AI** – Not satisfied with the initial scan? Tap _“Refine with AI”_ to enhance extraction accuracy instantly.
...
1.  Open your mobile app and navigate to **Contacts** or **Quick Actions → Add Contact**.
2.  Select **Scan Business Card**.
3.  Point your camera at the **front side** of the card and capture it.
4.  Optionally, scan the **back side** for additional details.
5.  Add Tags: From the same creation screen, select or add Tags to instantly organize contacts for targeted automations, campaigns, or follow-ups.
6.  Review your extracted details, phone, email, company, etc, auto-filled into the contact form.
7.  Optional

-   Toggle **Save to Media Storage** to keep the card image.
-   Toggle **Add to Files & Folders** to attach it to the contact record.

1.  If the extracted info seems off, tap **“Refine with AI”**, AI will enhance recognition and re-populate the fields with near-perfect accuracy.
2.  Tap **Save Contact**, and you’re done!

💡 Usage & Pricing

-   **Free Tier**: 50 AI scans/refinements per sub-account per day.
-   **Beyond Free Limit**: Just **$0.02 per additional scan**.
...
![Screenshot 2025-10-14 at 12](https://canny-assets.io/images/869eadfca643e04ba79c4e8fb350dc85.png)

![Screenshot 2025-10-14 at 12](https://canny-assets.io/images/26f63bccbc30d01c2d5b8965e9b2963b.png)

![Screenshot 2025-10-14 at 12](https://canny-assets.io/images/f29c1eee9a7a0e1786ba5d395523b849.png)
