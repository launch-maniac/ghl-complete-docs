---
title: "New WhatsApp Onboarding Flow: Connect, Create, or Migrate"
type: "changelog"
source: "ideas.gohighlevel.com"
guid: "69d7b09c958b5a4758c41be6"
author: "Umar Ranginwala"
pubDate: "2026-04-09T16:18:35.000Z"
link: "https://ideas.gohighlevel.com/changelog/new-whatsapp-onboarding-flow-connect-create-or-migrate"
categories: whatsapp,new
url: "https://ideas.gohighlevel.com/changelog/new-whatsapp-onboarding-flow-connect-create-or-migrate"
index: 4
---
...
![WhatsApp Business Account Setup](https://canny-assets.io/images/08e128c2a903d758d4cfa4d604e0865c.gif)
...
![Screenshot 2026-04-09 at 9](https://canny-assets.io/images/2592c6ae2f63c1df8d2352de41cb7e96.png)
...
\- **Connect your WhatsApp** Link your existing WhatsApp Business App and continue using it on your phone while managing conversations seamlessly inside the CRM. Up to 6 months of chat history will be synced automatically. Ideal for small businesses (like a local salon or real estate agent) that already talk to customers on WhatsApp and want to bring those conversations into the CRM without disrupting their daily workflow.

\- **Create a New WhatsApp Business Account:** Set up a fresh WhatsApp Business Account with a landline, a mobile number not currently on WhatsApp, or a brand new number. Great for agencies onboarding new clients who don't have an existing WhatsApp presence yet.

\- **Migrate from an Existing BSP:** Seamlessly transfer your existing WhatsApp Business Account from another provider to the CRM, preserving your phone number, quality rating, templates, and OBA status.

-   **In-App Guidance:** Each path includes prerequisites, things to keep in mind, and links to help documentation before you begin.

**📞 555 Business Phone Numbers**

![image](https://canny-assets.io/images/5d8ba854af92a556a69f11aa39cfd20f.png)
...
1.  In the sub-account, go to **Settings → WhatsApp**.
...
-   Click **Connect with Facebook** and follow the instructions to link your account.

![Screenshot 2026-04-09 at 9](https://canny-assets.io/images/6c9439ae36275a479e66a8b9622bde88.png)
...
-   If eligible, you'll see the option to claim a **555 business phone number** during the phone number addition step.
-   Click **Connect with Facebook** and follow the instructions to create and configure your new account.

![Screenshot 2026-04-09 at 9](https://canny-assets.io/images/ed20fa5e2e649b0ed44bd56081ed744a.png)

**Option C: Migrate from an Existing BSP**

-   Turn off two-step verification: go to [WhatsApp Manager](https://business.facebook.com/wa/manage/) → Phone Numbers → Select your number → Two-step verification → Turn off.
-   Confirm your business is verified in [Meta Business Manager](https://business.facebook.com/settings/) → Business Verification.
...
-   Click **Connect with Facebook** and follow the Embedded Signup flow to complete the migration.

![Screenshot 2026-04-09 at 9](https://canny-assets.io/images/3754c9b6e242a400eb25285c35391b31.png)
...
-   [Integration Guide](https://help.leadconnectorhq.com/support/solutions/articles/48001206219-how-to-enable-whatsapp-in-your-account-)
