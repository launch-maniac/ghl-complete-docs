---
title: "The All-New HighLevel Mobile App Experience - A complete redesign that redefines how you manage your business on the go."
type: "changelog"
source: "ideas.gohighlevel.com"
guid: "68ecfb9a6cf6b4ca95cfe72f"
author: "Urvash Singh"
pubDate: "2025-10-13T14:33:39.000Z"
link: "https://ideas.gohighlevel.com/changelog/the-all-new-highlevel-mobile-app-experience-a-complete-redesign-that-redefines-h"
categories: mobile app,new,improved
url: "https://ideas.gohighlevel.com/changelog/the-all-new-highlevel-mobile-app-experience-a-complete-redesign-that-redefines-h"
index: 5
---

# **🌟 Introduction**

We’ve reimagined the HighLevel mobile experience from the ground up, not just with a fresh coat of paint, but with a deeply thoughtful redesign that makes every moment on mobile more powerful, intuitive, and productive.
...
Welcome to the new era of HighLevel mobile.
...
![Homepage](https://canny-assets.io/images/2eb362493567a73f6857ad74e765e40f.png) ![Homepage-2](https://canny-assets.io/images/2a7d63c921af4e1501f6b6f9d70693dc.png)
...
![Universal Search](https://canny-assets.io/images/d382f2128f100c98cd3546a88b07a0a1.png)

![Universal search - with string](https://canny-assets.io/images/ea127dda92ecef5af02cecaa053f1db0.png)

# **📱 The App Drawer: Smart Navigation, Simplified**

Your new App Drawer brings structure and clarity to everything HighLevel offers. Organized into four intelligent categories, it mirrors the logical flow of your business — just like on web:
...
![App Drawer](https://canny-assets.io/images/96e9fe70ba00ab4c9d92611e80c5ca3d.png)
...
-   Perform almost all HighLevel MCP actions available on web, except for modules not yet on mobile (like Blogs or Funnels).
...
![Ask Ai](https://canny-assets.io/images/8b614cc1446a8a3ebb542659a79ceee6.png)

# 🔐**Abiding by SaaS Configurator**

We’ve brought **SaaS Configurator enforcement to the mobile app** — a highly requested update for our HighLevel resellers.

Previously, all modules and features on mobile were universally accessible to every user in every sub-account, regardless of the SaaS plan they were subscribed to. This meant that customers on lower-tier plans could use features on mobile that were restricted on web — creating inconsistencies in experience and access control.

That’s now fixed. The new mobile app fully respects the SaaS Configurator setup. This means that if a module or feature is restricted under a specific subscription tier, it will now be hidden and inaccessible on mobile, just as it is on web.

This enhancement ensures total alignment between web and mobile experiences — giving resellers full confidence that their tiered offerings, feature gates, and revenue models are now applied consistently across every platform.
...
![Homepage dark](https://canny-assets.io/images/9ffd2497db364d6f53d408561e3ce41f.png)

![Universal Search dark](https://canny-assets.io/images/320c56207050cb6d8872ed73e8d9dd18.png)

![App Drawer - dark](https://canny-assets.io/images/48a72fcc6cbbb1f092146f73afef5245.png)

![Ask AI - dark](https://canny-assets.io/images/c5d70bbdb2789977e912901405bfe7a3.png)

# **🔮 Coming Soon**

We’re not stopping here. The upcoming months (Q4 and beyond) will introduce:
...
This release lays the foundation for the next generation of the HighLevel mobile ecosystem - and what’s coming next will truly change how you operate.

# **🚀 How to Access the New Mobile App**

**1\. Update Your App**: Download the latest version from the App Store or Google Play.

**2\. Enable It in Labs**

-   Go to Agency Settings → Labs → Subaccounts.
-   Toggle on “A New Mobile App Experience.”
-   Select the subaccounts where you want to enable the new experience.

_💡 We recommend testing it on your agency subaccount first — get familiar with the new navigation before rolling it out to clients._

**3\. Dive In**: Once the toggle is enabled, open your mobile app and start exploring the new homepage, universal search, app drawer, and Ask AI.

# **💬 Final Thoughts**

The new HighLevel Mobile App isn’t just an update - it’s a revolution in how you experience your business on the go. It’s built to be faster, more intelligent, and deeply intuitive, transforming your pocket into a true business command center.

Every tap is smoother. Every screen is smarter. Every action feels lighter.

This is the future of HighLevel - redesigned for motion, powered by intelligence, and crafted for you.