---
title: "Expanded sound notifications for Live Chat Widget messages"
type: "changelog"
source: "ideas.gohighlevel.com"
guid: "6953dd4961d197e28dd1fed0"
author: "Manas Dixit"
pubDate: "2025-12-30T14:21:36.000Z"
link: "https://ideas.gohighlevel.com/changelog/expanded-sound-notifications-for-live-chat-widget-messages"
categories: chat widget,new
url: "https://ideas.gohighlevel.com/changelog/expanded-sound-notifications-for-live-chat-widget-messages"
index: 9
---
...
• **ON (default)**: A sound will play whenever a supported message is shown to the visitor.

• **OFF**: All messages are delivered silently without sound, popup, or badge interruptions.

![image](https://canny-assets.io/images/e705e8e863a3ded9ccd4f0af3d3b4d8b.png)
...
1.  Notification Sound is **enabled by default** for Live Chat widgets.
2.  The toggle applies to **all supported chat messages** listed above.
3.  Sub-accounts can control this setting independently per widget.
4.  Disabling the toggle will suppress **all sounds**, while messages will still appear normally.