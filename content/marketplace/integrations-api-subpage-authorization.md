...
extracted_at: "2025-10-06T00:49:28.700Z"
---
...
](#3-get-the-apps-authorization-page-url)
...
redirect\_uri=https://myapp.com/oauth/callback/gohighlevel&
...
](#what-are-current-rate-limits-for-api-20)
...
[Authorization](#authorization "Authorization")[1\. Register an OAuth app](#1-register-an-oauth-app "1. Register an OAuth app")[2\. Add the app to your desired location](#2-add-the-app-to-your-desired-location "2. Add the app to your desired location")[3\. Get the app's Authorization Page URL](#3-get-the-apps-authorization-page-url "3. Get the app's Authorization Page URL")[OAuth FAQs](#oauth-faqs "OAuth FAQs")[How long are the access tokens valid?](#how-long-are-the-access-tokens-valid "How long are the access tokens valid?")[How long are the refresh tokens valid?](#how-long-are-the-refresh-tokens-valid "How long are the refresh tokens valid?")[How should we handle token expiry?](#how-should-we-handle-token-expiry "How should we handle token expiry?")[What are current rate limits for API 2.0?](#what-are-current-rate-limits-for-api-20 "What are current rate limits for API 2.0?")